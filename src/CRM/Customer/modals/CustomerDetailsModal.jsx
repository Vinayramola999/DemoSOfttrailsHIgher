        ...
        <div className="flex-1 overflow-hidden flex flex-col px-5 py-4">
          <div className="flex justify-between items-center mb-4">
            <h4 className="font-semibold text-sm text-black">
              Contact Details{" "}
              {contacts &&
                contacts.filter((c) => c.customer_id === customer.customer_id)
                  .length > 0 &&
                `(${
                  contacts.filter((c) => c.customer_id === customer.customer_id)
                    .length
            ...
            {loadingContacts ? (
              ...
              <div className="min-w-full">
                      ...
                      <table className="min-w-full border-collapse">
                        ...
                        <thead className="sticky top-0 z-10">
                          <tr className="bg-gray-500">
                            <th className="px-3 py-2 text-left text-white text-xs font-medium">
                              Sr. no.
                            </th>
                            <th className="px-3 py-2 text-left text-white text-xs font-medium">
                              Contact person
                          ...
                          {contacts
                            ...
                            .map((contact, index) => (
                              ...
                              >
                                ...
                                <td
                                  className="px-3 py-1 text-xs font-medium text-black truncate"
                                  title={contact.email_id}
                                >
                                  {contact.email_id}
                                </td>
                                <td className="px-3 py-1 text-xs font-medium text-black">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    {hasAMSAccessEditContact && (
                                      <button
                                        ...
                                        onClick={() =>
                                          onEditContact &&
                                          onEditContact(contact.contact_id)
                                        }
                ...
                <div className="md:hidden space-y-3 max-h-96 overflow-y-auto">
                  {contacts
                    .filter(
                      (contact) => contact.customer_id === customer.customer_id
                    )
                    .map((contact, index) => (
                      <div
                        key={contact.contact_id || index}
                      ...
                      >
                        ...
                        <div className="text-sm text-gray-600 space-y-2">
                          <div className="flex flex-col sm:flex-row sm:items-center">
                            <span className="font-medium text-gray-800 min-w-0 sm:w-16 flex-shrink-0">
                              Email:
                            </span>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center">
                            ...
                            <span
                              className={`ml-0 sm:ml-1 px-2 py-1 rounded-full text-xs font-medium inline-block ${
                                contact.status?.toLowerCase() === "active"
                                  ? "bg-green-100 text-green-800"
                                  : "bg-red-100 text-red-800"
                              }`}
