...
import { FaUser, FaFile, FaProjectDiagram, FaTh, FaTimes, FaIndustry, FaCoins, FaUserShield, FaServer, FaUserCog, FaComments, FaClipboardList, FaTachometerAlt, FaBuilding, FaCalendarAlt, FaCog, FaShoppingCart } from 'react-icons/fa';
...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const [isHRMSOpen, setIsHRMSOpen] = useState(
        ...
        location.pathname.includes('/UploadEmpDocsTab')
    );
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div
                className={`fixed top-0 left-0 h-full w-64 bg-white border p-5 rounded-r-lg flex flex-col text-[14px] z-30 transform ${isOpen ? "translate-x-0" : "-translate-x-full"}
    transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 lg:w-[15%] lg:rounded-lg`}
                    ...
                    <ul className="list-none p-0">
                        ...
                        {hasAMSAccessHRMS && (
                            <li className="mt-1">
                                ...
                                {isHRMSOpen && (
                                    <ul className="ml-4">
                                        {hasAMSAccessLeave && (
                                            <li className="mt-1"><Link to="/Leave" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/Leave' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`}><FaCalendarAlt className="mr-2" /> Leave Management</Link></li>
                                        )}
                                        {hasAMSHR && (
                                            <li className="mt-1"> <Link to="/HRCorner" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/HRCorner' || location.pathname === '/UploadEmpDocsTab' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`}> <FaBuilding className="mr-2" /> HR Corner </Link></li>
                                        )}
                                        {hasAMSAccessAttendance && (
                                            <li className="mt-1"> <Link to="/AMSTab" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/AMSTab' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`}> <FaBuilding className="mr-2" /> Attendance Management </Link> </li>
                                        )}
                                        {hasAMSAccessPMS && (
                                            <li className="mt-1"> <Link to="/PMSTab" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/PMSTab' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`}> <FaBuilding className="mr-2" /> Performance Management </Link></li>
                                        )}
                                    </ul>
                                )}
                            </li>
                        ...
                        {hasAMSAccessASM && (
                            <li className="mt-1">
                                ...
                                {isAssetOpen && (
                                    <ul className="ml-4">
                                        <li className="mt-3">
                                            <Link to="/Reports" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/Reports' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`} > <FaTachometerAlt className="mr-2" />Dashboard </Link>
                                        </li>
                                        {hasAMSAccessApprovals && (
                                            <li className="mt-3">
                                                <Link to="/AllTab" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/AllTab' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`} > <FaUserCog className="mr-2" /> Approvals </Link>
                                            </li>
                                        )}
                                        {hasAMSAccessAsset && (
                                            <li className="mt-3"> <Link to="/RepoAllTab" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/RepoAllTab' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`} ><FaTh className="mr-2" /> Asset </Link> </li>
                                        )}
                                        {hasAMSAccessCategory && (
                                            <li className="mt-3"> <Link to="/CategoryTab" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/CategoryTab' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`} > <FaClipboardList className="mr-2" /> Asset Category </Link> </li>
                                        )}
                                        ...
                                        <li className="mt-3">
                                            <Link
                                                to="/AssetHistory"
                                                className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === '/AssetHistory' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`}
                                            >
                                ...
                                {isDmsOpen && (
                                    <ul className="ml-4">
                                        <li className="mt-1">
                                            <Link
                                                to="/dms/setup"
                                                className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/dms/setup"
                                        ...
                                        <li className="mt-1">
                                            <Link
                                                to="/dms/upload"
                                                className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/dms/upload"
                                                    ? "bg-blue-600 text-white"
                                                    : "hover:bg-blue-600 hover:text-white"
                                                    }`}
                                            >
                                        ...
                                        <li className="mt-1">
                                            <Link
                                                to="/dms/approval"
                                                className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/dms/approval"
                                                    ? "bg-blue-600 text-white"
                                                    : "hover:bg-blue-600 hover:text-white"
                                                    }`}
                                            >
                            ...
                            {isProcessOpen && (
                                <ul className="ml-4">
                                    <li className="mt-3">
                                        <Link
                                            to="/Project"
                                            className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/Project"
                                                ? "bg-blue-600 text-white"
                                                : "hover:bg-blue-600 hover:text-white"
                                                }`}
                                        >
                                    ...
                                    <li className="mt-3">
                                        <Link
                                            ...
                                            className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/AllocationRequest"
                                                ? "bg-blue-600 text-white"
                                                : "hover:bg-blue-600 hover:text-white"
                                                }`}
                                        >
                                    ...
                                    <li className="mt-3">
                                        <Link
                                            to="/Processtab"
                                            className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/Processtab"
                                                ? "bg-blue-600 text-white"
                                                : "hover:bg-blue-600 hover:text-white"
                                                }`}
                                        >
                                    ...
                                    <li className="mt-3">
                                        <Link
                                            ...
                                            className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/ProjectEstimation"
                                                ? "bg-blue-600 text-white"
                                                : "hover:bg-blue-600 hover:text-white"
                                                }`}
                                        >
                                    ...
                                    <li className="mt-3">
                                        <Link
                                            to="/ProductionOutput"
                                            className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/ProductionOutput"
                                                ? "bg-blue-600 text-white"
                                                : "hover:bg-blue-600 hover:text-white"
                                                }`}
                                        >
                                    ...
                                    <Link
                                        ...
                                        className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/ProductionRepository"
                                            ? "bg-blue-600 text-white"
                                            : "hover:bg-blue-600 hover:text-white"
                                            }`}
                                    >
                                ...
                                {isCrmOpen && (
                                    <ul className="ml-4">
                                        ...
                                        <li className="mt-1">
                                            <Link
                                                to="/CRMTabs"
                                                className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/CRMTabs"
                                                    ? "bg-blue-600 text-white"
                                                    : "hover:bg-blue-600 hover:text-white"
                                                    }`}
                                            >
                                        ...
                                        <li className="mt-1">
                                            <div onClick={toggleSalesManagementMenu} className="flex items-center p-2 text-black rounded cursor-pointer hover:bg-blue-600 hover:text-white transition-colors text-[10px]" > <FaUser className="mr-2" /> Sales Management</div>
                                            {isSalesManagementOpen && (
                                                <ul className="ml-6">
                                                    {/* Leads Tab */}
                                                    <li className="mt-1">
                                                        <Link to="/Lead" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/Lead" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`} > <FaUser className="mr-2" /> Leads </Link>
                                                    </li>
                                                    <li className="mt-1">
                                                        <Link to="/SalesProcess" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/SalesProcess" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`}> <FaUser className="mr-2" /> Sales Process</Link>
                                                    </li>
                                                </ul>
                                            )}
                                        </li>
                        ...
                        {hasAMSAccessPurchase && (
                            <li className="mt-1">
                                ...
                                {isPurchaseOpen && (
                                    <ul className="ml-4">
                                        <li className="mt-3">
                                            <Link to="/PurchaseModule" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/PurchaseModule" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`}><FaUserCog className="mr-2" /> Indent</Link>
                                        </li>
                                        <li className="mt-3">
                                            <Link to="/PurchaseApproval" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/PurchaseApproval" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`} > <FaUserCog className="mr-2" /> Approval </Link>
                                        </li>
                                        <li className="mt-3">
                                            <Link to="/PurchaseWorkflow" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/PurchaseWorkflow" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`} > <FaTh className="mr-2" /> Purchase Workflow </Link>
                                        </li>
                                        <li className="mt-3">
                                            <Link to="/PurchaseProcess" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/PurchaseProcess" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`} > <FaTh className="mr-2" /> Purchase Process </Link>
                                        </li>
                                        <li className="mt-3">
                                            <Link to="/VendorManagement" className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === "/VendorManagement" ? "bg-blue-600 text-white" : "hover:bg-blue-600 hover:text-white"}`} > <FaTh className="mr-2" /> Vendor Management </Link>
                                        </li>
                                    </ul>
                                )}
                            </li>
                        ...
                        {hasAMSAccessWorkflow && (
                            <li className="mt-1">
                                <Link
                                    to="/SetupWorkflow"
                                    className={`flex items-center p-2 rounded transition-colors text-[14px] ${location.pathname === "/SetupWorkflow"
                                        ? "bg-blue-600 text-white"
                        ...
                        {hasAMSAccessPrivilege && (
                            <li className="mt-1"> <Link to="/AccessPrivilege" className={`flex items-center p-2 text-black rounded transition-colors ${location.pathname === '/AccessPrivilege' ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`}> <FaUserShield className="mr-2" /> Access Privilege </Link> </li>
                        )}
                        {/* Logs */}
                        ...
                        <li className="mt-1">
                            ...
                            {isSettingsOpen && (
                                <ul className="ml-4">
                                    <li className="mt-3">
                                        <Link to={`/employeelayout/${userId}`} className={`flex items-center p-2 text-black rounded transition-colors text-[10px] ${location.pathname === `/employeelayout/${userId}` ? 'bg-blue-600 text-white' : 'hover:bg-blue-600 hover:text-white'}`} > <FaUser className="mr-2" /> Profile </Link>
                                    </li>
                                </ul>
                            )}
                        </li>
