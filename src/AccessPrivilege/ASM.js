...
const ASM = () => {
  ...
  const [isAssetChecked, setIsAssetChecked] = useState(false);
  const [isAssetMovableChecked, setIsAssetMovableChecked] = useState(false);
  const [isAssetRawMaterialChecked, setIsAssetRawMaterialChecked] = useState(false);
  const [isCategoryChecked, setIsCategoryChecked] = useState(false);
  const [isValuationChecked, setIsValuationChecked] = useState(false);
  const [isWorkflowChecked, setIsWorkflowChecked] = useState(false);
  const [isAllCategoryChecked, setIsAllCategoryChecked] = useState(false);
  ...
  const handleEmailChange = async (e) => {
    ...
    if (userId) {
      try {
        ...
        setIsAsmChecked(apiAccessNames.includes("ASM"));
        setIsAssetMovableChecked(apiAccessNames.includes("AssetMovable"));
        setIsAssetRawMaterialChecked(apiAccessNames.includes("AssetRawMaterial"));
        setIsApprovalChecked(apiAccessNames.includes("Approvals"));
        setIsLogsChecked(apiAccessNames.includes("Logs"));
        setIsAssetChecked(apiAccessNames.includes("RepoAllTab"));
        setIsCategoryChecked(apiAccessNames.includes("Category"));
  ...
  const handleAssetCheckboxChange = () => {
    const newCheckedState = !isAssetChecked;
    setIsAssetChecked(newCheckedState);
    setIsAssetMovableChecked(newCheckedState);
    setIsAssetRawMaterialChecked(newCheckedState);
  };
      ...
      <div className="bg-white p-4 rounded-lg h-[75vh] shadow-md mt-3">
        <form onSubmit={handleSubmit} className="flex flex-col min-h-[70vh]">
          ...
          <div className="flex flex-col sm:flex-row mt-6"> 
            <div className="w-full sm:w-1/2 rounded-lg scrollbar-hide p-4 overflow-y-auto h-[300px]">
              <label className="flex items-center">
                <input type="checkbox" onChange={handleAsmCheckboxChange} checked={isAsmChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="text-blue-600 text-lg font-bold ml-5"> Asset Management </span>
              </label>

              {isAsmChecked && (
                <div className="ml-5 mt-3">
                  <label className="flex items-center">
                    <input type="checkbox" onChange={() => setIsApprovalChecked(!isApprovalChecked)} checked={isApprovalChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Approvals</span>
                  </label>
                  <label className="flex items-center mt-2">
                    <input type="checkbox" onChange={() => setIsLogsChecked(!isLogsChecked)} checked={isLogsChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Logs</span>
                  </label>
                  <label className="flex items-center mt-2">
                    <input type="checkbox" onChange={handleAssetCheckboxChange} checked={isAssetChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Asset</span>
                  </label>
                  {isAssetChecked && (
                    <div className="ml-6 mt-2">
                      <label className="flex items-center mt-2">
                        <input type="checkbox" onChange={() => setIsAssetMovableChecked(!isAssetMovableChecked)} checked={isAssetMovableChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Movable</span>
                      </label>
                      <label className="flex items-center mt-2">
                        <input type="checkbox" onChange={() => setIsAssetRawMaterialChecked(!isAssetRawMaterialChecked)} checked={isAssetRawMaterialChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Raw Material</span>
                      </label>
                    </div>
                  )}
                  <label className="flex items-center mt-2">
                    <input type="checkbox" onChange={() => setIsCategoryChecked(!isCategoryChecked)} checked={isCategoryChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Asset Category</span>
                  </label>
                  {isCategoryChecked && (
                    <div className="ml-6 mt-2">
                      <label className="flex items-center mt-2">
                        <input type="checkbox" onChange={() => setIsAllCategoryChecked(!isAllCategoryChecked)} checked={isAllCategoryChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">All Category Type</span>
                      </label>
                      <label className="flex items-center mt-2">
                        <input type="checkbox" onChange={() => setIsIndexChecked(!isIndexChecked)} checked={isIndexChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Movable Asset</span>
                      </label>
                      <label className="flex items-center mt-2">
                        <input type="checkbox" onChange={() => setIsRawMaterialChecked(!isRawMaterialChecked)} checked={isRawMaterialChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Raw Material</span>
                      </label>
                    </div>
                  )}
                  <label className="flex items-center mt-2">
                    <input type="checkbox" onChange={() => setIsValuationChecked(!isValuationChecked)} checked={isValuationChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Asset Valuation</span>
                  </label>
                  <label className="flex items-center mt-2">
                    <input type="checkbox" onChange={() => setIsWorkflowChecked(!isWorkflowChecked)} checked={isWorkflowChecked} className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" /> <span className="ml-2">Asset Workflow</span>
                  </label>
                </div>
              )}
            </div>
